...
class AndroidManifestEditorTask(private val isDebug: Boolean, private val isAddApplication: Boolean,val unZipFile: File) : Task<File, File>() {
    companion object{
        private const val PROXY_APPLICATION_NAME = "com.ks.XpApplication"
